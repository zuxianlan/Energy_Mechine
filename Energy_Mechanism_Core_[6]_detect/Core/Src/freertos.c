...
osThreadId M15Handle;
uint32_t CoreBuffer[ 512 ];
osStaticThreadDef_t CoreControlBlock;
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of M15 */
  osThreadStaticDef(M15, M15_task, osPriorityHigh, 0, 512, CoreBuffer, &CoreControlBlock);
  M15Handle = osThreadCreate(osThread(M15), NULL);
...
/* USER CODE BEGIN Header_M15_task */
/**
* @brief Function implementing the M15 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_M15_task */
__weak void M15_task(void const * argument)
{
  /* USER CODE BEGIN M15_task */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END M15_task */
}
...
__weak void run_task(void const * argument)
{
